...
public class ProductGenerator {
    ...
    private static final List<String> ADJECTIVES = List.of("빨간", "파란", "노란", "초록", "보라", "하얀", "샛노란", "새빨간", "검정", "크림",
    ...
    private static final List<String> CATEGORIES = List.of("세트", "정장", "턱시도", "연미복", "프록 코트", "유니폼", "교복", "군복",
